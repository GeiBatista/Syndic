 ...
 * @author Albert Eije
 */
public class RateioGasLookupController extends LookupController {

    private Connection conn = null;
    public static VOListResponse condominioImp;

    public RateioGasLookupController(Connection conn) {
        this.conn = conn;
        this.setLookupDataLocator(new LookupDataLocator() {
            ...
            public Response validateCode(String code) {
                Statement stmt = null;
                try {
                    stmt = RateioGasLookupController.this.conn.createStatement();
