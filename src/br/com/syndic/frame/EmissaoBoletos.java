 ...
 * @author Albert Eije
 */
public class EmissaoBoletos extends InternalFrame implements ActionListener {
    ...
    public EmissaoBoletos(Connection conn) {
        this.conn = conn;
        try {
            initComponents();
            setSize(750, 300);
...
//            detControle = new RateioGasDetalheController(this, conn);
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == btInicia) {
            EmissaoBoletos.this.btIniciaActionPerformed(evt);
        }
        else if (evt.getSource() == btConsultaMovimento) {
            EmissaoBoletos.this.btConsultaMovimentoActionPerformed(evt);
        }
        else if (evt.getSource() == btImportaInquilinos) {
            EmissaoBoletos.this.btImportaInquilinosActionPerformed(evt);
        }
        else if (evt.getSource() == btCalculaRateio) {
            EmissaoBoletos.this.btCalculaRateioActionPerformed(evt);
        }
        else if (evt.getSource() == btCancela) {
            EmissaoBoletos.this.btCancelaActionPerformed(evt);
        }
        else if (evt.getSource() == btSalva) {
            EmissaoBoletos.this.btSalvaActionPerformed(evt);
        }
        else if (evt.getSource() == btSair) {
            EmissaoBoletos.this.btSairActionPerformed(evt);
        }
    ...
    private void btConsultaMovimentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConsultaMovimentoActionPerformed
        ...
        if ((gasC.getCodCondominio() == null) || (gasC.getMesAno() == null)) {
            ...
            try {
                ...
                Logger.getLogger(EmissaoBoletos.class.getName()).log(Level.SEVERE, null, ex);
            }
